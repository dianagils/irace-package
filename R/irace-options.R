...
"--min-survival", "--num-configurations", "--mu", "--confidence", "--subsetsFile"
...
"0", "0", "0", "5", "0.95", "./subsets.txt"), domain = c(NA, NA, NA, NA, NA, NA, 
...
"minNbSurvival", "nbConfigurations", "mu", "confidence", "instanceSubsetsFile"), class = "data.frame")
...
"boundPar", "boundAsTimeout", "postselection", "aclib", "nbIterations", 
"nbExperimentsPerIteration", "minNbSurvival", "nbConfigurations", 
"mu", "confidence", "instanceSubsetsFile")

...
"--min-survival", "--num-configurations", "--mu", "--confidence", "--num-partitions"
...
"0", "0", "0", "5", "0.95", "3"), domain = c(NA, NA, NA, NA, NA, NA, 
...
"Confidence level for the elimination test.", "Number of partitions for domains used to cluster configurations")), row.names = c(".help", 
...
"minNbSurvival", "nbConfigurations", "mu", "confidence", "nbPartitions"), class = "data.frame")

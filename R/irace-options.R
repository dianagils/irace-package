...
"--min-survival", "--num-configurations", "--mu", "--confidence", "--partitions", "--prob-type"
...
"0", "0", "0", "5", "0.95", "4", "2"), domain = c(NA, NA, NA, NA, NA, NA, 
...
NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA), description = c("Show this help.", 
...
"Number of partitions to use for clustering numerical variables",
"Value used for calculating weight of representatives. `1` for rank, `2` for mean results, `3` for using ranked postitions"
), value = c(NA, NA, NA, NA, NA, "./scenario.txt", "./", "./parameters.txt",
)), row.names = c(".help", 
...
"minNbSurvival", "nbConfigurations", "mu", "confidence", "nbPartitions", "probType"), class = "data.frame")
...
"boundPar", "boundAsTimeout", "postselection", "aclib", "nbIterations", 
"nbExperimentsPerIteration", "minNbSurvival", "nbConfigurations", 
"mu", "confidence", "nbPartitions", "probType")

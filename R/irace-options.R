...
"--nb-partitions", "--prob-type"), default = c(NA, NA, NA, "", "", "./scenario.txt", "./", "./parameters.txt", 
...
"0", "0", "0", "5", "0.95", "3", "1"), domain = c(NA, NA, NA, NA, NA, NA, 
...
"Number of partitions to use in the partitioning of the numerical space.",
"Type of probability"
)), row.names = c(".help", 

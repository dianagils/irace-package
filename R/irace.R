  ...
  repeat {
    ...
    if (firstRace) {
      ...
      if (scenario$softRestart) {
        for (subset_number in unique(subsets$SubsetNumber)) {
          # configs for the current subset
          configs_subset <- raceConfigurations[raceConfigurations$isAliveInSubset == subset_number, ]
          
          tmp.ids <- similarConfigurations (configs_subset, parameters,

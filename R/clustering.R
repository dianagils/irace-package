...
filterClusteringParams <- function(parameters, clusterAll) {
  # parameters: list of parameters
  # returns: list of parameters
  # remove parameter names that have clustering = FALSE
  # copy parameters
  if (clusterAll) {
    cat("Clustering all parameters.\n")
    return(parameters)
  }
  cat ("Clustering only selected parameters.\n")
...
clusterConfigurations <- function(parameters, configurations, nbClusters) {
  ...
  configurations$.CLUSTER. <- clusterAssignments
  printCluster(nbClusters, configurations)
  return (configurations)
}

printCluster <- function(nbClusters, configurations) {
...
summarizeClusters <- function(configurations) {
  ...
  for (cluster in unique_clusters) {
      ...
      subset_df <- configurations[configurations$.CLUSTER. == cluster,]
...
getClusterRepresentatives <- function(configurations, columnName, summary) {
  ...
  cat("Representatives for each ALIVE cluster :\n")
